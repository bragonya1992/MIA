...
function OneSignal(apiKey, appId, sandbox) {
   ...
   * @return {Promise}
   */
  this.createNotification = function(message, data, oneSignalIds,curse,section) {
    var keyGroup=curse+section;
    var content = "$[notif_count] contenidos nuevos en " +curse;
    var title=curse+" "+section;
    if(curse=="publication")
      title = "Nueva publicacion FARUSAC"
    var options = {
      method: 'POST',
      ...
      body: JSON.stringify({
        ...
        /*contents:{"en": "nuevo material", "es": "nuevo conteni},*/
        android_group_message:{en : content, es : content},
        large_icon:"new_logo",
        small_icon:"new_logo",
        android_sound:"dog",
        android_group: keyGroup
